...
P="ssh-agent-on-demand"
FILES="src/ssh-agent-on-demand.cpp src/ssh-agent-utils.cpp src/ssh-agent-utils.h src/utils.cpp src/utils.h"
FILES+=" makefile configure README.md COPYING-GPL.txt authors.txt ssh-agent-on-demand_help.txt ssh-agent-on-demand_more_help.txt"
